...
while true; do
    ...
    # Fixed command syntax with proper filter expression placement
    # Note: The filter expression needs to be placed after all options
    tcpdump -i any -w - -U -B $BUFFER_SIZE -s $MAX_SNAPLEN -K -Q \
