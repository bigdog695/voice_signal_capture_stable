...
MAX_SNAPLEN=262144  # Standard snaplen value (262KB)
...
while true; do
    ...
    # -s $MAX_SNAPLEN: Increase capture length to avoid truncating large packets
    # --time-stamp-precision=micro: Use microsecond precision to reduce timestamp issues
